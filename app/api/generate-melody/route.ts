...
const CATEGORY = {
  ...
  rhythm: ['X', 'Y', 'Z', '12', '13', '15', '16', '17', '18', '19', '20', '22', '23', '24', '25', '26', '27', '28', '29', '35', '36', '37', '38', '39'],
...
function validateCombined(allBars: string[], level: string, recipe: typeof RECIPES[number]): string | null {
  ...
  // 2:1:1 리듬(23~25)이 여태 한 번도 안 나왔다는 피드백 — 프롬프트로 부탁만
  // 해서는 계속 무시되므로 실제로 강제함 (요구치가 낮아 다른 카테고리와
  // 충돌할 여지가 적음)
...
23: CD/E/ F2 D2 C2 (8분음표가 앞: 8분+16분+16분)
...
리듬 심화: X,Y,Z,12,13,15,16,17,18,19,20,22,23,24,25,26,27,28,29,35,36,37,38,39
당김음: 8,9,11,14,26,27
...
JSON 객체로만 응답:
{
  ...
  "patterns": [
    ...
    {"label": "당김음·도약·2:1:1리듬·16분음표런", "bars": ["9", "17", "V", "1", "H", "P", "23", "35"]}
  ]
}`
}
